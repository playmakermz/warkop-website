...
class Menu {
    ...
    public void Main() {
        ...
        printer.tampilMenu();
        jsonNode.put("id", item.id);
        jsonNode.put("nama", item.nama);
        jsonNode.put("harga", item.harga);
        jsonNode.put("kategori", item.kategori);
...
class Pesanan {
    ...
    public void Main() {
        ...
        for (MenuItem item : jsonNode){

            int idN = item.get("id").asText();
            String namaN = item.get("nama").asInt();
            int hargaN = item.get("harga").asText();
            String kategori = item.get("kategori").asText();
